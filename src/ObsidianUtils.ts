...
export function genEditorSettings(setting: EditorSettings, language: string, minimap: boolean = true, wordwrap: boolean = false) {
	...
	let fontFamily = setting.fontFamily as string[] | undefined;
	if (fontFamily !== undefined && (fontFamily.length == 0 || (fontFamily.length === 1 && fontFamily[0] === ""))) {
		fontFamily = undefined;
	}
	let fontFamilyFinal = undefined as string | undefined;
	if (fontFamily !== undefined) {
		fontFamilyFinal = fontFamily.join(",");
	}
